...
if ($_POST) {
    ...
    echo "<div style='text-align:center; padding:50px;'><div style='background:#e8f5e9; max-width:400px; margin:0 auto; padding:30px; border-radius:20px;'><img src='https://tse3.mm.bing.net/th/id/OIP.fVEBMBTRydlJYElJ_FwflAHaEb?rs=1&pid=ImgDetMain&o=7&rm=3' style='width:150px; height:150px; object-fit:cover; border-radius:50%; display:block; margin:0 auto 20px;'><h2 style='color:green;'>Спасибо, $name!</h2><p>Ваша заявка на усыновление {$animal['name']} отправлена.</p><a href='animals.php' class='btn'>Вернуться</a></div></div>";
    exit;
}
?>
<!doctype html>
